  ...
  return (
    <section className="py-12 md:py-16 lg:py-20 px-4 md:px-6 bg-white">
      <div className="max-w-5xl mx-auto">
        <h2
          className="text-2xl md:text-3xl lg:text-4xl text-center mb-8 md:mb-12 text-[#CE2B37]"
          style={{ fontFamily: 'Rye, cursive' }}
        >
          La Commedia all'Italiana
        </h2>

        <div className="bg-gradient-to-br from-[#009246]/5 to-[#CE2B37]/5 p-4 md:p-6 lg:p-8 rounded-lg border-2 border-[#009246] mb-8 md:mb-12">
          <p className="text-sm md:text-base lg:text-lg text-gray-800 leading-relaxed mb-4 md:mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
          <div className="bg-white p-4 md:p-6 rounded-lg shadow-lg border-2 border-[#009246] hover:border-[#CE2B37] transition-colors">
            <div className="flex justify-center mb-4">
              <Laugh className="w-10 md:w-12 h-10 md:h-12 text-[#CE2B37]" />
            </div>
            <h3 className="text-lg md:text-xl mb-3 text-center text-[#009246]" style={{ fontFamily: 'Cinzel, serif' }}>
              Satire as Weapon
            </h3>
          ...
          <div className="bg-white p-4 md:p-6 rounded-lg shadow-lg border-2 border-[#009246] hover:border-[#CE2B37] transition-colors">
            <div className="flex justify-center mb-4">
              <Heart className="w-10 md:w-12 h-10 md:h-12 text-[#CE2B37]" />
            </div>
            <h3 className="text-lg md:text-xl mb-3 text-center text-[#009246]" style={{ fontFamily: 'Cinzel, serif' }}>
              Complex Women
            </h3>
          ...
          <div className="bg-white p-4 md:p-6 rounded-lg shadow-lg border-2 border-[#009246] hover:border-[#CE2B37] transition-colors">
            <div className="flex justify-center mb-4">
              <MessageCircle className="w-10 md:w-12 h-10 md:h-12 text-[#CE2B37]" />
            </div>
            <h3 className="text-lg md:text-xl mb-3 text-center text-[#009246]" style={{ fontFamily: 'Cinzel, serif' }}>
              Cultural Mirror
            </h3>
